...
def paste_up(data_sets):
    ...
    for data in range(len(data_sets)-1):
        ...
        if data_sets[s][2] == 'Upside down':
            if (data_sets[s][0]) == 'Sheet A' and (data_sets[s][2]) == 'Upside down':
                setheading(270)
                pendown()
                Sheet_A()
                penup()
            elif (data_sets[s][0]) == 'Sheet B' and (data_sets[s][2]) == 'Upside down':
                setheading(0)
                pendown()
                Sheet_B()
                penup()
            elif (data_sets[s][0]) == 'Sheet C' and (data_sets[s][2]) == 'Upside down':
                setheading(0)
                pendown()
                Sheet_C()
                penup()
            elif (data_sets[s][0]) == 'Sheet D' and (data_sets[s][2]) == 'Upside down':
                setheading(0)
                pendown()
                Sheet_D()
                penup()
